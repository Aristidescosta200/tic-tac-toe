...
export const BaseCenterLayoutStep = () => {
  ...
  return (
    <div className="absolute bottom-4 px-4 flex items-center justify-between right-0 left-0">
      <button
        data-opacity={currentStep === 0}
        onClick={onPreviousStep}
        className="data-[opacity=true]:opacity-0 text-neutral text-xl font-bold"
      >
        Voltar
      </button>
      <Steps />
      <button
        data-opacity={currentStep === totalSteps}
        onClick={onNextStep}
        className="data-[opacity=true]:opacity-0 text-xl"
      >
        Próximo
      </button>
    </div>
